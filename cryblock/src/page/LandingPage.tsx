    ...
    <div>
      ...
      <div className="pt-10 ml-48">
        ...
        <div className="flex justify-center -mt-36 mr-72">
          <div
            className="w-56 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-200 dark:border-gray-200 relative overflow-hidden transition-colors duration-300 hover:bg-blue-200"
